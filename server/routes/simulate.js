...
//     const net_savings = cumulative_savings - (one_time_implementation_cost || 0);
//     const payback_months = (one_time_implementation_cost || 0) / monthly_savings;
//     const roi_percentage = (net_savings / (one_time_implementation_cost || 1)) * 100;
...
router.post('/', (req, res) => { // ← Use '/' here
    const { monthly_invoice_volume, num_ap_staff, avg_hours_per_invoice, hourly_wage, error_rate_manual, error_cost, time_horizon_months, one_time_implementation_cost } = req.body;
